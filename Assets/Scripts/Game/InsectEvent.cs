...
public class InsectEvent : EventClass {
	...
	void Update(){
		...
		if (waterTimeTemp > WaterTimeInterval) {
			waterTimeTemp = 0;
			GameObject _water =	Instantiate (bird, transform, false);
			float _t = Random.Range (50, 300);
			_water.transform.localPosition = new Vector3 (-700, _t, 0);
